...
public class ThongKeSach {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ThongKeSach window = new ThongKeSach();
	...
	private void initialize() {
		...
		frame.getContentPane().add(fromTimeTF);
		...
		frame.getContentPane().add(toTimeTF);
		...
		stratButton.setBounds(127, 346, 89, 23);
		frame.getContentPane().add(stratButton);

		finishButton = new JButton("Kết thúc");
		...
		finishButton.setBounds(257, 346, 89, 23);
